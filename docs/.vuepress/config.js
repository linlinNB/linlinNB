...
module.exports = {
  ...
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/watrix.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'watrix，components' }],
      ...
      icons: [
        {
          ...
          title: 'GitHub',
          link: 'http://192.168.0.20:9080/gait/web/frontend-docs'
        },
      ]
    },
    footer: { // 页脚信息
